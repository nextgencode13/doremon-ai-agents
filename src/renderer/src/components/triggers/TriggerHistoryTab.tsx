        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <div style={{ ...uiText, fontSize: 11, lineHeight: '16px', color: 'var(--cth-ink-700)' }}>
            {pending.kind === 'directive'
              ? 'Approve and this goes to Doraemon, who will put the hive to work on it. Reject and it is dropped — nothing runs.'
              : 'Approve and Doraemon reads this. Reject and it is dropped — nothing runs.'}
          </div>
        ...
        {exchanges.length === 0 ? (
          source === 'org' ? (
            ...
            <EmptyState
              ...
              body={'When something posts to one of your endpoints, it lands here with Doraemon’s '
