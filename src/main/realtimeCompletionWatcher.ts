/**
 * Realtime Doraemon — completion watcher (card rt-12, Phase 2, "respond when done").
 *
 * When voice-Doraemon DISPATCHES work (fire-and-notify, the default pattern), he does
 ...
 * make Doraemon speak it unprompted ("Oscar finished — want details?").
 *
...
/** A unit of work voice-Doraemon dispatched and is now awaiting completion of. */
 ...
 * field here reaches Doraemon. `summary` is the human-speakable line; `completedAt` is
 ...
 * whitespace, and cap length so a malicious objective can't steer what Doraemon says or does.
