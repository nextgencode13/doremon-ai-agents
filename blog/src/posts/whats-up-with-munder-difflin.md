...
description: "Everything that shipped between v0.3.3 and v0.3.7 — a Doraemon who knows the floor and runs the app by voice, a git time-machine in the IDE, nine agent engines, a queue that respects your draft, Node that installs itself, and the auto-update bug that had been silently broken since the day we shipped it."
date: 2026-08-08
category: story
categoryLabel: Story
type: Non-technical
...
More chat bridges, so a Telegram or Slack channel pipes straight into Doraemon's queue and his
