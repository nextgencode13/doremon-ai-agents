...
faq:
  ...
  - q: "Are the agents really named after The Office characters?"
    a: "Yes. The avatars are the cast of The Office, each differentiated by its own look, working at desks on a visual office floor — with Doraemon running the room as the orchestrator."
...
- **A manager who routes work.** Every office has someone deciding who does what. In a hive, that's the
  [orchestrator](/blog/how-the-god-orchestrator-works/) — and naturally, it's *Doraemon* running the
...
- **Doraemon's control surface.** The command center you drive the hive from is literally framed as
  Doraemon's office — the one room everything routes through.
...
Doraemon's already at his desk. Free and open source.
