...
Click spawn. The agent appears at a desk, joins the hive with its own mailbox and long-term memory, and is immediately routable: assign it kanban tasks, or just tell the GOD orchestrator what you need and let [Doraemon route the work](/blog/how-the-god-orchestrator-works/).
