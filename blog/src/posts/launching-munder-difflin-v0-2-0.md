...
The Command Center — Doraemon's control surface — got the biggest single overhaul of the release. It's now the
...
- **@albozes** — Doraemon cancelling his own bypass-permissions prompt (#2).
