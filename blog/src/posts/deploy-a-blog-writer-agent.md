...
<strong>isolated worktree</strong> from a topic brief + a house-style reference; <strong>Doraemon</strong>
...
The writer **never commits**. It writes a plain file; **Doraemon** owns every commit. This is
