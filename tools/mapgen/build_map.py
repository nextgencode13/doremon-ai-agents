...
Doraemon's corner office, conference room, the open bullpen with desk pods,
...
# ══ ROOMS ════════════════════════════════════════════════════════════════════
# Doraemon's office (top-left). Interior cols 1-6 rows 3-7.
vwall(7, 3, 10, doors=(5,))
hwall(8, 1, 7, doors=(5,))                       # south door into the floor
doraemon = place(EXEC, 2, 4)                     # boss desk, faces room (down)
place(PLANT2, 1, 3)
place(WINDOW, 2, 1)
