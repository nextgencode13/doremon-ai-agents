'use strict';
/**
 * Munder Difflin brand mark — Doraemon's portrait on the brand yellow tile.
 *
...
// face between them — read as two detached dark tabs rather than as Doraemon's
...
// ── run ───────────────────────────────────────────────────────────────────
const grid = buildGrid(centreEyes(art.sceneFrameBufs('doraemon').front[0]));
